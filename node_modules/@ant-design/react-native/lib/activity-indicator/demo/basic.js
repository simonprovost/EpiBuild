  ...
  (0, _createClass3['default'])(ActivityIndicatorExample, [{
    ...
    value: function render() {
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            ...
            _react2['default'].createElement(
              _.Flex.Item,
              null,
              _react2['default'].createElement(_.ActivityIndicator, null)
            )
          )
        ),
        _react2['default'].createElement(_.WhiteSpace, { size: 'xl', style: { backgroundColor: '#fff' } }),
        _react2['default'].createElement(
          _.WingBlank,
          null,
          _react2['default'].createElement(
            ...
            _react2['default'].createElement(
              _.Flex.Item,
              null,
              _react2['default'].createElement(_.ActivityIndicator, { text: 'Loading...' })
            )
          )
        ),
        _react2['default'].createElement(_.WhiteSpace, { size: 'xl', style: { backgroundColor: '#fff' } }),
          ...
          _react2['default'].createElement(
            ...
            _react2['default'].createElement(
              ...
              _react2['default'].createElement(
                _reactNative.View,
                { style: [styles.darkBg] },
                _react2['default'].createElement(_.ActivityIndicator, { color: '#fff' })
              )
            )
          )
        ),
        ...
        _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            ...
            _react2['default'].createElement(
              _.Flex.Item,
              null,
              _react2['default'].createElement(_.ActivityIndicator, { size: 'large' })
            )
          )
        ),
        _react2['default'].createElement(_.WhiteSpace, { size: 'xl', style: { backgroundColor: '#fff' } }),
        ...
        _react2['default'].createElement(_.ActivityIndicator, { animating: this.state.animating, toast: true, size: 'large', text: 'Loading...' })
      );
    }
  }]);
