...
var AgreeItem = _.Checkbox.AgreeItem;
var CheckboxItem = _.Checkbox.CheckboxItem;
    ...
    value: function render() {
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          _reactNative.View,
          { style: { padding: 10 } },
          _react2['default'].createElement(_.Checkbox, { checked: this.state.checkBox1, style: { color: '#f00' }, onChange: function onChange(event) {
          ...
          _react2['default'].createElement(_.WhiteSpace, null),
          _react2['default'].createElement(_.Checkbox, { checked: true, disabled: true }),
          _react2['default'].createElement(_.WhiteSpace, null),
          _react2['default'].createElement(_.Checkbox, { disabled: true })
        ),
        _react2['default'].createElement(_.WhiteSpace, null),
        _react2['default'].createElement(
          AgreeItem,
        ...
        _react2['default'].createElement(
          AgreeItem,
          { checked: this.state.agreeItem1, checkboxStyle: { color: '#f00' }, onChange: function onChange(event) {
