...
var _cascader = require('../picker/cascader');

var _cascader2 = _interopRequireDefault(_cascader);

var _MultiPicker = require('../picker/MultiPicker');
...
var PickerView = function (_React$Component) {
    ...
    (0, _createClass3['default'])(PickerView, [{
        ...
        value: function render() {
            ...
            var picker = void 0;
            if (props.cascade) {
                picker = _react2['default'].createElement(_cascader2['default'], { data: props.data, value: props.value, onChange: props.onChange, onScrollChange: props.onScrollChange, cols: props.cols, indicatorStyle: props.indicatorStyle, pickerItemStyle: props.itemStyle });
            } else {
