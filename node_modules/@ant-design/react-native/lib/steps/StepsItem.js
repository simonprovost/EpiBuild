            ...
            return _react2['default'].createElement(
                ...
                function (_, theme) {
                    ...
                    if (renderIcon) {
                        ...
                        if (starting) {
                            iconSource = _react2['default'].createElement(_icon2['default'], { name: 'check', color: theme.color_icon_base, style: styles['icon' + sizeCls] });
                        } else if (waiting) {
                            iconSource = _react2['default'].createElement(_icon2['default'], { name: 'ellipsis', color: theme.color_icon_base, style: styles['icon' + sizeCls] });
                            if (!!icon) {
                                iconSource = icon;
                            }
                        } else if (error) {
                            iconSource = _react2['default'].createElement(_icon2['default'], { name: 'close', color: theme.color_icon_base, style: styles['icon' + sizeCls] });
                        }
                    }
                    ...
                    return _react2['default'].createElement(
                        ...
                        _react2['default'].createElement(
                            ...
                            _react2['default'].createElement(
                                ...
                                _react2['default'].isValidElement(iconSource) ? iconSource : null
                            ),
                            _react2['default'].createElement(_reactNative.View, { style: [styles['tail_default' + sizeCls + styleSuffix], styles[tailTopCls]] }),
                            _react2['default'].createElement(_reactNative.View, { style: [styles['tail_default' + sizeCls + styleSuffix], styles[tailBottomCls]] })
                        ),
                        _react2['default'].createElement(
                            _reactNative.View,
