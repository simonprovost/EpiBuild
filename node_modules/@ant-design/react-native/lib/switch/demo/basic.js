        ...
        value: function render() {
            return _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                    _.List.Item,
                    { extra: _react2['default'].createElement(_.Switch, { checked: true }) },
                    'On(controlled)'
                ),
                _react2['default'].createElement(
                    _.List.Item,
                    { extra: _react2['default'].createElement(_.Switch, null) },
                    'Off(controlled)'
                ),
                _react2['default'].createElement(
                    _.List.Item,
                    { extra: _react2['default'].createElement(_.Switch, { checked: this.state.checked, onChange: this.onSwitchChange }) },
                    'onChange event, switch status: ',
                    this.state.checked ? 'open' : 'close'
                ),
                _react2['default'].createElement(
                    _.List.Item,
                    { extra: _react2['default'].createElement(_.Switch, { disabled: true }) },
                    'disabled'
                ),
                _react2['default'].createElement(
                    _.List.Item,
                    { extra: _react2['default'].createElement(_.Switch, { color: 'red', checked: true }) },
                    'color'
                )
            );
        }
