    ...
    (0, _createClass3['default'])(DatePickerViewExample, [{
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(
                ...
                _react2['default'].createElement(_.DatePickerView, { value: this.state.value12hours, onChange: function onChange(v) {
                ...
                _react2['default'].createElement(_.DatePickerView, { value: this.state.value, onChange: this.onChange, onValueChange: this.onValueChange }),
                _react2['default'].createElement(
                    _reactNative.Text,
                    { style: { margin: 16 } },
                    'End DateTime'
