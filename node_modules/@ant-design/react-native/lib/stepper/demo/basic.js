...
var StepperExample = function (_React$Component) {
  ...
  (0, _createClass3['default'])(StepperExample, [{
    ...
    value: function render() {
      var readOnly = _react2['default'].createElement(_.Stepper, { key: '1', max: 10, min: 1, readOnly: false, defaultValue: 1, onChange: onChange });
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            _.List.Item,
            { extra: _react2['default'].createElement(_.Stepper, { key: '0', max: 10, min: 1, defaultValue: 3, onChange: onChange }) },
            'readOnly: true'
          ),
          _react2['default'].createElement(
            _.List.Item,
          ...
          _react2['default'].createElement(
            _.List.Item,
            { extra: _react2['default'].createElement(_.Stepper, { key: '2', disabled: true, max: 10, min: 1, defaultValue: 3, onChange: onChange }) },
            'Disabled'
          )
        )
      );
