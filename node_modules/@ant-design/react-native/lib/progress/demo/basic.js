    ...
    (0, _createClass3['default'])(BasicProgressExample, [{
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(
                _reactNative.View,
                null,
                _react2['default'].createElement(_.Progress, { percent: 90, position: 'fixed' }),
                _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(
                        ...
                        _react2['default'].createElement(_.Progress, { percent: this.state.percent })
                    ),
                    _react2['default'].createElement(
                        _reactNative.Text,
                        null,
                ...
                _react2['default'].createElement(
                    _.Button,
                    { style: { width: 50, marginLeft: 10 }, type: 'ghost', size: 'small', onPress: this.onAdd },
                    '(+-)10'
                ),
                _react2['default'].createElement(_.WhiteSpace, null),
                _react2['default'].createElement(_.Progress, { percent: 5 })
            );
        }
    }]);
