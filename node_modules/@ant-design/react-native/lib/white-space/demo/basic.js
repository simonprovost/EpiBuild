    ...
    (0, _createClass3['default'])(WhiteSpaceExample, [{
        ...
        value: function render() {
            return _react2['default'].createElement(
                _reactNative.View,
                null,
                _react2['default'].createElement(_.WhiteSpace, { size: 'xs' }),
                _react2['default'].createElement(PlaceHolder, null),
                _react2['default'].createElement(_.WhiteSpace, { size: 'sm' }),
                _react2['default'].createElement(PlaceHolder, null),
                _react2['default'].createElement(_.WhiteSpace, null),
                _react2['default'].createElement(PlaceHolder, null),
                _react2['default'].createElement(_.WhiteSpace, { size: 'lg' }),
                _react2['default'].createElement(PlaceHolder, null),
                _react2['default'].createElement(_.WhiteSpace, { size: 'xl' }),
                _react2['default'].createElement(PlaceHolder, null)
            );
        }
    }]);
