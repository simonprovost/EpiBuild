        ...
        value: function render() {
            return _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                    _.List,
                    { renderHeader: '基本' },
                    _react2['default'].createElement(_.TextareaItem, { rows: 4, placeholder: '\u56FA\u5B9A\u884C\u6570' }),
                    _react2['default'].createElement(_.TextareaItem, { rows: 4, placeholder: '\u591A\u884C\u5E26\u8BA1\u6570', count: 100 }),
                    _react2['default'].createElement(_.TextareaItem, { rows: 4, placeholder: '\u9AD8\u5EA6\u81EA\u9002\u5E94', autoHeight: true, style: { paddingVertical: 5 } }),
                    _react2['default'].createElement(_.TextareaItem, { value: this.state.val, onChange: this.onChange }),
                    _react2['default'].createElement(_.TextareaItem, { value: '\u4E0D\u53EF\u7F16\u8F91 editable = {false}', editable: false }),
                    _react2['default'].createElement(_.TextareaItem, { clear: false, placeholder: '\u4E0D\u663E\u793A\u6E05\u9664\u6309\u94AE' }),
                    _react2['default'].createElement(_.TextareaItem, { error: true, defaultValue: '\u62A5\u9519\u6837\u5F0F error={true}', onErrorClick: function onErrorClick() {
                            return _.Toast.fail('Error message');
                        } })
                )
            );
        }
