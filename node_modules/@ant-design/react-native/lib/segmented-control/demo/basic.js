    ...
    (0, _createClass3['default'])(BasicTagExample, [{
        ...
        value: function render() {
            return _react2['default'].createElement(
                ...
                _react2['default'].createElement(_.SegmentedControl, { values: ['Segment1', 'Segment2'], disabled: true }),
                ...
                _react2['default'].createElement(_.SegmentedControl, { values: ['Segment1', 'Segment2', 'Segment3'], tintColor: '#ff0000', style: { height: 40, width: 280 } }),
                _react2['default'].createElement(_.WhiteSpace, { size: 'lg' }),
                _react2['default'].createElement(
                    _reactNative.Text,
                    null,
                ...
                _react2['default'].createElement(_.SegmentedControl, { selectedIndex: 1, values: ['Segment1', 'Segment2', 'Segment3'] }),
                _react2['default'].createElement(_.WhiteSpace, { size: 'lg' }),
                _react2['default'].createElement(
                    _reactNative.Text,
                    null,
                ...
                _react2['default'].createElement(_.SegmentedControl, { values: ['Segment1', 'Segment2', 'Segment3'], onChange: this.onChange, onValueChange: this.onValueChange })
            );
        }
    }]);
