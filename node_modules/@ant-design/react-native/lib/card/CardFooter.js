    ...
    (0, _createClass3['default'])(CardFooter, [{
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(
                ...
                function (s) {
                    var contentDom = content !== undefined && _react2['default'].isValidElement(content) ? _react2['default'].createElement(
                        _reactNative.View,
                        { style: { flex: 1 } },
                        content
                    ...
                    var extraDom = extra !== undefined && _react2['default'].isValidElement(extra) ? _react2['default'].createElement(
                        _reactNative.View,
                        { style: { flex: 1 } },
                        extra
                    ) : _react2['default'].createElement(
                    ...
                    return _react2['default'].createElement(
                        _reactNative.View,
                        (0, _extends3['default'])({ style: [s.footerWrap, style] }, restProps),
                        contentDom,
                        extra ? extraDom : null
                    );
                }
