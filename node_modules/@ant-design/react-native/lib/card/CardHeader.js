    ...
    (0, _createClass3['default'])(CardHeader, [{
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(
                _style.WithTheme,
                { styles: styles, themeStyles: _style3['default'] },
                function (s) {
                    var titleDom = title === undefined ? null : _react2['default'].isValidElement(title) ? _react2['default'].createElement(
                        _reactNative.View,
                    ...
                    var extraDom = extra === undefined ? null : _react2['default'].isValidElement(extra) ? _react2['default'].createElement(
                        _reactNative.View,
                    ...
                    return _react2['default'].createElement(
                        _reactNative.View,
                        (0, _extends3['default'])({ style: [s.headerWrap, style] }, restProps),
                        _react2['default'].createElement(
                            _reactNative.View,
                            { style: [s.headerTitle] },
                            typeof thumb === 'string' ? _react2['default'].createElement(_reactNative.Image, { source: { uri: thumb }, style: [s.headerImage, thumbStyle] }) : thumb,
                            titleDom
                        ),
                        extra ? extraDom : null
                    );
