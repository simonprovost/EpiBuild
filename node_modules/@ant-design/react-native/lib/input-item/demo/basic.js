    ...
    (0, _createClass3['default'])(BasicInputItemExample, [{
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(
                ...
                { style: { flex: 1 }, automaticallyAdjustContentInsets: false, showsHorizontalScrollIndicator: false, showsVerticalScrollIndicator: false, keyboardShouldPersistTaps: 'handled' },
                _react2['default'].createElement(
                    _.List,
                    { renderHeader: '基本' },
                    _react2['default'].createElement(
                        _.InputItem,
                        { clear: true, error: true, value: this.state.value, onChange: function onChange(value) {
                                _this2.setState({
                                    value: value
                                });
                    ...
                    _react2['default'].createElement(
                        _.InputItem,
                        { clear: true, value: '\u4E0D\u53EF\u7F16\u8F91', onChange: function onChange(value) {
                                _this2.setState({
                                    value: value
                                });
                    ...
                    _react2['default'].createElement(
                        _.InputItem,
                        { clear: true, value: 'disabled', onChange: function onChange(value) {
                                _this2.setState({
                                    value: value
                                });
                            }, extra: _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(_.InputItem, { clear: true, value: this.state.value1, onChange: function onChange(value) {
                            _this2.setState({
                                value1: value
                            });
                        }, placeholder: '\u65E0\u6807\u7B7E' }),
