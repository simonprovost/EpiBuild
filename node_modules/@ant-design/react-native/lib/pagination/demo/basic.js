    ...
    (0, _createClass3['default'])(BasicPaginationExample, [{
        ...
        value: function render() {
            return _react2['default'].createElement(
                ...
                _react2['default'].createElement(_.Pagination, { total: 5, current: 1, locale: locale }),
                _react2['default'].createElement(_.WhiteSpace, { size: 'lg' }),
                _react2['default'].createElement(_.Pagination, { simple: true, total: 5, current: 1, locale: locale }),
                _react2['default'].createElement(_.WhiteSpace, { size: 'lg' }),
                _react2['default'].createElement(_.Pagination, { mode: 'number', total: 5, current: 3 }),
                _react2['default'].createElement(_.WhiteSpace, { size: 'lg' }),
                _react2['default'].createElement(_.Pagination, { mode: 'pointer', total: 5, current: 2 })
            );
        }
    }]);
